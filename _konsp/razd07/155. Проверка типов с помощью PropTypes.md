...
Вы можете определить статические свойства [propTypes](https://www.npmjs.com/package/prop-types) вместе с библиотекой типов свойств, чтобы объявить типы свойств, принимаемых вашим компонентом. Эти типы будут проверяться только во время рендеринга и разработки.
...
> Примечание
>- Мы рекомендуем использовать [TypeScript](https://www.typescriptlang.org/) вместо проверки типов свойств во время выполнения.
...
> Примечание:
><br>С версии React 15.5 `React.PropTypes` были вынесены в отдельный пакет. Так что используйте библиотеку [prop-types](https://www.npmjs.com/package/prop-types).
><br>Вы можете использовать [codemod-скрипт](https://ru.legacy.reactjs.org/blog/2017/04/07/react-v15.5.0.html#migrating-from-reactproptypes), чтобы провести замену в коде на использование этой библиотеки.
...
В данном примере проверка типа показана на классовом компоненте, но она же может быть применена и к функциональным компонентам, или к компонентам, созданным с помощью [React.memo](https://ru.legacy.reactjs.org/docs/react-api.html#reactmemo) или [React.forwardRef](https://ru.legacy.reactjs.org/docs/react-api.html#reactforwardref).
...
- Проверка типов с помощью PropTypes
	- https://ru.legacy.reactjs.org/docs/typechecking-with-proptypes.html
- проверить домашнее задание
	- https://github.com/yankovalenko94/JS_task_answers/tree/master/React_Redux_step_17

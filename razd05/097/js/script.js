	...
	*/
	...
	function initCalc() {
		const vElement_Calc = document.querySelector('div.calculating'),
			...
			vGenderArr = vElement_Gender.querySelectorAll('.calculating__choose-item'),
		...
		function doCalc() {
			const vData = {
				height: +vElement_Height.value,
				weight: +vElement_Weight.value,
				age:    +vElement_Age.value
			};
			let vRes = '____';
